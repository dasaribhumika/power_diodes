...
const Form9 = () => {
  ...
  const calculateLambdaValue = () => {
    if (piT && tauIValue && tauOnValue && tauOffValue && piNValue && deltaTValue && selectedPhase  && maxTemp && ths) {
      ...
      const result = (0.4 * ((πt * τi) / (τon + τoff) + 1.4 * Math.pow(10, -3) * (πn * Math.pow(ΔT, 0.68)))) * Math.pow(10, -9);
        ...
        case '0.1':
          switch (ths) {
            ...
            case '20':
              ...
              break;
            case '30':
              calculatedPiN = 0.00072;
              break;
            case '40':
              calculatedPiN = 0.00078;
              break;
            case '50':
              calculatedPiN = 0.00084;
              break;
            case '60':
              calculatedPiN = 0.00092;
              break;
            case '70':
              calculatedPiN = 0.0010;
              break;
            case '80':
              calculatedPiN = 0.0011;
              break;
            case '90':
              calculatedPiN = 0.0012;
              break;
            case '100':
              calculatedPiN = 0.0013;
              break;
            case '110':
              calculatedPiN = 0.0015;
              break;
            case '120':
